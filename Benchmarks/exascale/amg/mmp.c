   ...
   //#pragma clang unrolling full
         ...
         if ( (m[0] * m[1] * m[2]) > 1)
         {
            ...
            for (box = 0; box < pdata.nboxes; box++)
            {
               ...
               i = box;
#pragma clang loop(r, q, p) tile sizes(#P1, #P5, #P6)
...
#pragma clang loop(k, j, i) tile sizes(#P1, #P5, #P6)
      ...
      char *argv[] )
{
   ...
   for (part = 0; part < data.nparts; part++)
   {
      ...
      /* set stencil values */
#pragma clang loop(var, i) tile sizes(#P4, #P5)
...
#pragma clang loop(entry, j) tile sizes(#P4, #P5)
...
#pragma clang loop id(j)
   ...
   //#pragma omp parallel for
      ...
      {
         pdata = data.pdata[part];
#pragma clang loop(var, box) tile sizes(#P4, #P5)
#pragma clang loop id(var)
         for (var = 0; var < pdata.nvars; var++)
         {
